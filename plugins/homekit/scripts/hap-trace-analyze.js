    ...
    for (const event of events) {
        ...
        if (type === "hap-snapshot-result") {
            snapshotResults.push({
                ...
                readyElapsedMs: event.readyElapsedMs,
                callbackElapsedMs: event.callbackElapsedMs,
                deliveryGuardEnabled: event.deliveryGuardEnabled,
                deliveryGuardApplied: event.deliveryGuardApplied,
                deliveryGuardClassification: event.deliveryGuardClassification,
                deliveryGuardRequestElapsedMs: event.deliveryGuardRequestElapsedMs,
                deliveryGuardFloorMs: event.deliveryGuardFloorMs,
                deliveryGuardFloorSlackMs: event.deliveryGuardFloorSlackMs,
                deliveryGuardSpacingMs: event.deliveryGuardSpacingMs,
                deliveryGuardPreviousHandoffDeltaMs: event.deliveryGuardPreviousHandoffDeltaMs,
                deliveryGuardSpacingSlackMs: event.deliveryGuardSpacingSlackMs,
                deliveryGuardReadyDelayMs: event.deliveryGuardReadyDelayMs,
                deliveryGuardQueueAhead: event.deliveryGuardQueueAhead,
                deliveryGuardPlannedSleepMs: event.deliveryGuardPlannedSleepMs,
                deliveryGuardTimerWaits: event.deliveryGuardTimerWaits,
                deliveryGuardEligibilityWaitMs: event.deliveryGuardEligibilityWaitMs,
                deliveryGuardCohortOwnerCount: event.deliveryGuardCohortOwnerCount,
                deliveryGuardCohortSpanMs: event.deliveryGuardCohortSpanMs,
                deliveryGuardFailedOpen: event.deliveryGuardFailedOpen,
                deliveryGuardFailedOpenReason: event.deliveryGuardFailedOpenReason,
                bytes: event.bytes,
                sha256: event.sha256,
                soi: event.soi,
                eoi: event.eoi,
